      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/share/1BbjuVNLaL/" aria-label="Facebook" target="_blank" className="text-gray-400 hover:text-job-primary">
            ...
            <a href="https://www.linkedin.com/in/human-resources-nmhm-12aab6366/" target="_blank" aria-label="LinkedIn" className="text-gray-400 hover:text-job-primary">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
